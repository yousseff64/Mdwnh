...
function initTable(r, stage) {
  ...
  /* Armed, the pieces wait off the table (CSS holds --e at 0) until it is
     ...
     The trigger is held back on purpose. Reading the bottom third of the
     screen out of the observed box means the table has to climb properly
     into view before it deals, instead of dealing itself out along the
     bottom edge where most people scroll straight past it. */
  ...
  }, { threshold: 0.25, rootMargin: '0px 0px -30% 0px' }).observe(stage);
}
