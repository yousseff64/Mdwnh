...
export const NEWS = [
  {
    ...
    body: 'شاب يقف أمام باب الحجرة، وحوله في الظلام عيون كثيرة، كلها تنظر إليه. شاهد التشويقة الرسمية، ثم اقرأ الحكاية كاملة في قصة مصورة من ٤٣ صفحة.',
  ...
  },
  {
    ...
    body: 'رسالة تخرج من سمرقند إلى دمشق، تحمل شكوى مدينة كاملة. فيلم قصير من التاريخ الإسلامي في أقل من ثلاث دقائق، والحكاية كاملة في قصة مصورة من ٥١ صفحة.',
...
export const PROJECTS = [
  ...
  { id: 'fasl', name: 'فصل عجيب', role: 'سلسلة كوميدية', year: '٢٠٢٥', cover: 'assets/img/covers/fasl.webp', accent: '#c35bff' },
...
/* ------------------------------------------------- project detail pages ---
   ...
   Synopses only say what the video, its description, its tags or its
   thumbnail show. غمام's award is the one on the home page (إنجازاتنا).
--------------------------------------------------------------------------- */
...
export const PROJECT_PAGES = {
  samarqand: {
    ...
    tagline: 'رسالة من سمرقند إلى دمشق، وحكم لم يتوقعه أحد.',
    body: [
      'في بلاد ما وراء النهر، يكتب أهل سمرقند شكوى ضد الجيش الذي دخل مدينتهم، ويحملها رسول إلى دمشق. لا أحد يتوقع أن تُقرأ، ولا أحد يتوقع ما سيأتي بعدها.',
      'حكاية من التاريخ الإسلامي فيها مغامرة وتشويق. شاهد الفيلم القصير في أقل من ثلاث دقائق، ثم اقرأ الحكاية كاملة في قصة مصورة من ٥١ صفحة.'
    ],
  ...
  ghamam: {
    ...
    yt: 'bCkfuh_2yUE',
    scene: 'smoke',
    tagline: 'ضغط الجامعة، وكلام الناس، وشاب يظن أنه وحده.',
    body: [
      'غمام طالب جامعي يحمل ضغطًا لا يراه من حوله: منافسة لا تهدأ، وتوتر أمام الناس، وكلام يسمعه كل يوم حتى يصدقه.',
  ...
  hujra: {
    ...
    tagline: 'باب واحد، وعيون كثيرة في الظلام تنتظر أن يُفتح.',
    body: [
      'شاب يقف أمام باب الحجرة، وحوله في الظلام عيون كثيرة، كلها تنظر إليه. ماذا ينتظره خلف الباب؟',
  ...
  lis: {
    ...
    yt: '0y3jSrG-Gto',
    scene: 'sparkle',
    tagline: 'جائع تسلّل إلى بيت ليسرق، فخرج منه بما لم يتوقعه.',
    body: [
      'شاب فقير لم يأكل منذ أيام، يتسلل إلى بيت غريب. يجد الطعام أمامه، ثم يتوقف عند أول لقمة.',
      'حكاية رواها الشيخ علي الطنطاوي في كتابه فصول في الثقافة والأدب. رسمناها وحركناها ضمن مدونة الرسم، بخطوط بسيطة وألوان دافئة.'
    ],
  ...
  fasl: {
    ...
    yt: 'DstPIXlD090',
    scene: 'space',
    tagline: 'هل السفر عبر الزمن ممكن؟ معلمنا يجرب بنفسه، ويسقط في ثقب أسود.',
    body: [
      'معلم علوم بنظارة واقية وشارب مرتبك، لا يكتفي بشرح النظرية على السبورة: يجربها بنفسه، ويدفع الثمن.',
      'حلقة كوميدية قصيرة حول سؤال واحد: هل يمكن أن نسافر عبر الزمن؟ الفيزياء وراء السؤال في أقل من أربع دقائق.'
    ],
    crew: ['كتابة', 'رسم', 'تحريك', 'مونتاج'],
    stats: [
  ...
  qird: {
    ...
    tagline: 'صداقة على شجرة تين، وحيلة في عرض البحر.',
    body: [
      'من حكايات كليلة ودمنة: قرد يعيش على شجرة تين، يصادق غيلمًا يزوره كل يوم، حتى يدعوه الغيلم إلى بيته في عرض البحر.',
      'قصة مصورة من ١٨ صفحة، نشرناها مع منصة 505error للقصص المصورة. هذا الإعلان يعرّفك بها، والقصة كاملة تقرؤها الآن.'
    ],
